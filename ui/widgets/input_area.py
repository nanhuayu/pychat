...
class InputArea(QWidget):
    ...
    def _setup_ui(self):
        ...
        label1 = QLabel("服务商:")
        label1.setObjectName("input_label")
        selector_row.addWidget(label1)
        
        self.provider_combo = QComboBox()
        self.provider_combo.setObjectName("provider_combo")
        self.provider_combo.setMaximumWidth(120)
        self.provider_combo.currentIndexChanged.connect(self._on_provider_changed)
        selector_row.addWidget(self.provider_combo)
        
        label2 = QLabel("模型:")
        label2.setObjectName("input_label")
        selector_row.addWidget(label2)
        ...
        selector_row.addWidget(self.model_combo)
